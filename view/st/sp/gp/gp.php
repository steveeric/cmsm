...
<script src="../../../../module/script/grouping/gp.js"></script>
...
<body>
	...
	<div data-role="page" id="todayGroup" data-theme="b">
		<div data-role="header">
			<h1>本日の着席位置</h1>
		</div>
		<div data-role="content" style="text-align: center">
		<p class="idFieald"></p>
		<p class="groupFieald"></p>
	...
	<div data-role="page" id="group" data-theme="b">
		<div data-role="header">
			<h1>着席位置</h1>
		</div>
		<div data-role="content" style="text-align: center">
		<p class="groupPastFieald"></p>
